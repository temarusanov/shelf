...
type BaseOptions<T extends ZodTypeAny> = WrapWithZodOptions<BaseTypeOptions, T>
 ...
 */
export function MethodWithZodModel<T extends ZodTypeAny>(
    input: T,
 ...
 * @return {MethodDecorator} A method decorator.
 */
export function MethodWithZod<T extends ZodTypeAny>(
    input: T,
    nameOrOptions: string | BaseOptions<T> | undefined,
    graphqlDecoratorFactory: GraphQLMDF<BaseTypeOptions>,
) {
