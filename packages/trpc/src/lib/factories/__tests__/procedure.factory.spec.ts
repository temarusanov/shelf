...
import { initTRPC, ProcedureBuilder, TRPCError } from '@trpc/server'
import { z } from 'zod'

import { Ctx, Input, Options, Query, UseMiddlewares } from '../../decorators'
...
describe('ProcedureFactory', () => {
    ...
    describe('getProcedures', () => {
        it('should return procedures', () => {
            ...
            ;(
                procedureFactory['metadataScanner']
                    .scanFromPrototype as jest.Mock
    ...
    describe('serializeProcedures', () => {
        it('should serialize procedures into a trpc procedure', () => {
            ...
            expect(result.getUserById._def.output).toEqual(
                mockProcedures[0].output,
            )
