...
describe('TRPCGenerator', () => {
    ...
    describe('generateSchemaFile', () => {
        it('should generate schema file', async () => {
            const mockRouters = [
                { name: 'TestRouter', instance: {}, alias: 'test' },
            ]
            ...
            routerGenerator.serializeRouters.mockResolvedValue(
                mockRoutersMetadata,
            )
            ...
            ;(fileUtil.saveOrOverrideFile as jest.Mock).mockResolvedValue(
                undefined,
            )
    ...
    describe('generateHelpersFile', () => {
        it('should generate helpers file', async () => {
            ...
            expect(
                middlewareGenerator.getMiddlewareInterface,
            ).toHaveBeenCalled()
            expect(fileUtil.saveOrOverrideFile).toHaveBeenCalled()
            expect(consoleLogger.log).toHaveBeenCalledWith(
